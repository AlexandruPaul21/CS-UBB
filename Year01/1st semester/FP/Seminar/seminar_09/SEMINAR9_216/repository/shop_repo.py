...
class ShopRepoFileInheritance(ShopInMemoryRepo):
    def __init__(self, filename):
        ShopInMemoryRepo.__init__(self)
        self.__filename = filename
    ...
    def __save_to_file(self):
        ...
        shops = ShopInMemoryRepo.get_all(self)
        with open(self.__filename, 'w') as f:
            for shop in shops:
                shop_string = str(shop.getId()) + ';' + str(shop.getName()) + ';' + str(
                    shop.getLocation()) + '\n'
    ...
    def update(self, id, new_shop):
        ...
        updated_shop = ShopInMemoryRepo.update(self, id, new_shop)
        self.__save_to_file()
        return updated_shop
    ...
    def delete(self, id):
        ...
        deleted_shop = ShopInMemoryRepo.delete(self, id)
        self.__save_to_file()
        return deleted_shop
